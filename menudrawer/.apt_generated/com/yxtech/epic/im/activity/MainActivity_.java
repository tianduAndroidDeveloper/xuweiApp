    ...
    implements HasViews
{
    ...
    @Override
    public void onPostExecute(final long count) {
        handler_.post(new Runnable() {


            @Override
            public void run() {
                MainActivity_.super.onPostExecute(count);
            }
    ...
    public void doInBackground() {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    MainActivity_.super.doInBackground();
                } catch (Throwable e) {
    ...
    public static class IntentBuilder_ {
        ...
        public MainActivity_.IntentBuilder_ localMember(Member localMember) {
