...
public class ConditionDialog extends Activity implements OnClickListener {
	...
	void initUI() {
		...
		adapter = new ConditionAdapter(this, rg_condition.getChildAt(0).getTag().toString(), new Callback() {

			@Override
			public void callBack(String condition, String index, String valueId) {
				if (containtId(condition)) {
					return;
				}
				Log.i(TAG, "index = " + index + ",id = " + valueId);
	...
	private RadioButton initRadioButton() {
		...
		rb.setPadding(dp10, dp10, dp10, dp10);
		rb.setSingleLine();
		...
		rb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
				arg0.setTextColor(arg1 ? Color.WHITE : Color.BLACK);
			}
		});
		return rb;
	}
